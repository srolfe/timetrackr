...
app.configure(function(){
	...
	app.use(express.session({secret: 'helloWorld', cookie: { maxAge: null }}));
...
// -- Socket IO Events -- \\
app.io.route('checkSession',function(req){
...
app.io.route('needSheetData',function(req){
...
app.io.route('recordTimestamp',function(req){
	//var timeC=(req.data!=undefined)?req.data.timeC:Date.now();
	//var timeS=(req.data!=undefined)?req.data.timeS:Date.now();
